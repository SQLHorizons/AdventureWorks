CREATE TABLE [Production].[BillOfMaterials] (
    ...
    CONSTRAINT [CK_BillOfMaterials_BOMLevel] CHECK ([BillOfMaterials].[ProductAssemblyID] IS NULL AND [BillOfMaterials].[BOMLevel]=(0) AND [BillOfMaterials].[PerAssemblyQty]=(1.00) OR [BillOfMaterials].[ProductAssemblyID] IS NOT NULL AND [BillOfMaterials].[BOMLevel]>=(1)),
    CONSTRAINT [CK_BillOfMaterials_EndDate] CHECK ([BillOfMaterials].[EndDate]>[BillOfMaterials].[StartDate] OR [BillOfMaterials].[EndDate] IS NULL),
    CONSTRAINT [CK_BillOfMaterials_PerAssemblyQty] CHECK ([BillOfMaterials].[PerAssemblyQty]>=(1.00)),
    CONSTRAINT [CK_BillOfMaterials_ProductAssemblyID] CHECK ([BillOfMaterials].[ProductAssemblyID]<>[BillOfMaterials].[ComponentID]),
