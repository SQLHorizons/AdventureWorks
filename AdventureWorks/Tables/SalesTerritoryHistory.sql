CREATE TABLE [Sales].[SalesTerritoryHistory] (
    ...
    CONSTRAINT [CK_SalesTerritoryHistory_EndDate] CHECK ([SalesTerritoryHistory].[EndDate]>=[SalesTerritoryHistory].[StartDate] OR [SalesTerritoryHistory].[EndDate] IS NULL),
