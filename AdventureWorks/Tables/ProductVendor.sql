CREATE TABLE [Purchasing].[ProductVendor] (
    ...
    CONSTRAINT [CK_ProductVendor_AverageLeadTime] CHECK ([ProductVendor].[AverageLeadTime]>=(1)),
    CONSTRAINT [CK_ProductVendor_LastReceiptCost] CHECK ([ProductVendor].[LastReceiptCost]>(0.00)),
    CONSTRAINT [CK_ProductVendor_MaxOrderQty] CHECK ([ProductVendor].[MaxOrderQty]>=(1)),
    CONSTRAINT [CK_ProductVendor_MinOrderQty] CHECK ([ProductVendor].[MinOrderQty]>=(1)),
    CONSTRAINT [CK_ProductVendor_OnOrderQty] CHECK ([ProductVendor].[OnOrderQty]>=(0)),
    CONSTRAINT [CK_ProductVendor_StandardPrice] CHECK ([ProductVendor].[StandardPrice]>(0.00)),
