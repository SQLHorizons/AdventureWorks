CREATE TABLE [Sales].[SalesOrderHeader] (
    ...
    [SalesOrderNumber]       AS                    (isnull(N'SO'+CONVERT([nvarchar](23),[SalesOrderHeader].[SalesOrderID]),N'*** ERROR ***')),
    ...
    [TotalDue]               AS                    (isnull(([SalesOrderHeader].[SubTotal]+[SalesOrderHeader].[TaxAmt])+[SalesOrderHeader].[Freight],(0))),
    ...
    CONSTRAINT [CK_SalesOrderHeader_DueDate] CHECK ([SalesOrderHeader].[DueDate]>=[SalesOrderHeader].[OrderDate]),
    CONSTRAINT [CK_SalesOrderHeader_Freight] CHECK ([SalesOrderHeader].[Freight]>=(0.00)),
    CONSTRAINT [CK_SalesOrderHeader_ShipDate] CHECK ([SalesOrderHeader].[ShipDate]>=[SalesOrderHeader].[OrderDate] OR [SalesOrderHeader].[ShipDate] IS NULL),
    CONSTRAINT [CK_SalesOrderHeader_Status] CHECK ([SalesOrderHeader].[Status]>=(0) AND [SalesOrderHeader].[Status]<=(8)),
    CONSTRAINT [CK_SalesOrderHeader_SubTotal] CHECK ([SalesOrderHeader].[SubTotal]>=(0.00)),
    CONSTRAINT [CK_SalesOrderHeader_TaxAmt] CHECK ([SalesOrderHeader].[TaxAmt]>=(0.00)),
