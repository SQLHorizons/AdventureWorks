CREATE TABLE [Production].[ProductListPriceHistory] (
    ...
    CONSTRAINT [CK_ProductListPriceHistory_EndDate] CHECK ([ProductListPriceHistory].[EndDate]>=[ProductListPriceHistory].[StartDate] OR [ProductListPriceHistory].[EndDate] IS NULL),
    CONSTRAINT [CK_ProductListPriceHistory_ListPrice] CHECK ([ProductListPriceHistory].[ListPrice]>(0.00)),
