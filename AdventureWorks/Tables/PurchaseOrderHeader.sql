CREATE TABLE [Purchasing].[PurchaseOrderHeader] (
    ...
    [TotalDue]        AS       (isnull(([PurchaseOrderHeader].[SubTotal]+[PurchaseOrderHeader].[TaxAmt])+[PurchaseOrderHeader].[Freight],(0))) PERSISTED NOT NULL,
    ...
    CONSTRAINT [CK_PurchaseOrderHeader_Freight] CHECK ([PurchaseOrderHeader].[Freight]>=(0.00)),
    CONSTRAINT [CK_PurchaseOrderHeader_ShipDate] CHECK ([PurchaseOrderHeader].[ShipDate]>=[PurchaseOrderHeader].[OrderDate] OR [PurchaseOrderHeader].[ShipDate] IS NULL),
    CONSTRAINT [CK_PurchaseOrderHeader_Status] CHECK ([PurchaseOrderHeader].[Status]>=(1) AND [PurchaseOrderHeader].[Status]<=(4)),
    CONSTRAINT [CK_PurchaseOrderHeader_SubTotal] CHECK ([PurchaseOrderHeader].[SubTotal]>=(0.00)),
    CONSTRAINT [CK_PurchaseOrderHeader_TaxAmt] CHECK ([PurchaseOrderHeader].[TaxAmt]>=(0.00)),
