CREATE TABLE [Production].[ProductInventory] (
    ...
    CONSTRAINT [CK_ProductInventory_Bin] CHECK ([ProductInventory].[Bin]>=(0) AND [ProductInventory].[Bin]<=(100)),
    CONSTRAINT [CK_ProductInventory_Shelf] CHECK ([ProductInventory].[Shelf] like '[A-Za-z]' OR [ProductInventory].[Shelf]='N/A'),
