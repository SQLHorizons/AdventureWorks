CREATE TABLE [HumanResources].[EmployeePayHistory] (
    ...
    CONSTRAINT [CK_EmployeePayHistory_PayFrequency] CHECK ([EmployeePayHistory].[PayFrequency]=(2) OR [EmployeePayHistory].[PayFrequency]=(1)),
    CONSTRAINT [CK_EmployeePayHistory_Rate] CHECK ([EmployeePayHistory].[Rate]>=(6.50) AND [EmployeePayHistory].[Rate]<=(200.00)),
